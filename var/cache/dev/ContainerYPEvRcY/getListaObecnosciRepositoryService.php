 ...
 */
class getListaObecnosciRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ListaObecnosciRepository' shared autowired service.
     *
     * @return \App\Repository\ListaObecnosciRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ListaObecnosciRepository.php';

        return $container->privates['App\\Repository\\ListaObecnosciRepository'] = new \App\Repository\ListaObecnosciRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
