...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\ListaObecnosciRepository' => ['privates', 'App\\Repository\\ListaObecnosciRepository', 'getListaObecnosciRepositoryService', true],
            'App\\Repository\\PrezentyRepository' => ['privates', 'App\\Repository\\PrezentyRepository', 'getPrezentyRepositoryService', true],
        ], [
            'App\\Repository\\ListaObecnosciRepository' => '?',
            'App\\Repository\\PrezentyRepository' => '?',
        ])));
