 ...
 */
class getPrezentyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PrezentyRepository' shared autowired service.
     *
     * @return \App\Repository\PrezentyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PrezentyRepository.php';

        return $container->privates['App\\Repository\\PrezentyRepository'] = new \App\Repository\PrezentyRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
